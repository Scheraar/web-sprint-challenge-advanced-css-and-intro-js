...
function myFunction(array, index, name) {
  array[index].name = name;
  return array;
}
console.log(myFunction(artists, 8, 'Vincent Van Gogh'));
...
/* Task 4: Create a function called get20s() that takes data as an argument
 and returns an array with names of artists who were born in and died in 20th
  century (1900-2000) example born in 1901 and died in 1959 - included / born 
  in 1889 and died in 1925 not included - should return ["Salvador Dali", "Frida Kahlo"]*/
...
function addArtist(array, name, years, genre, nationality, bio) {
  array.unshift({ name, years, genre, nationality, bio });
  return array;
}
console.log(addArtist(artists, 'Aaron Scherer', '1999-Current day', 'Web Design', 'White', 'I like cats and pizza'))
